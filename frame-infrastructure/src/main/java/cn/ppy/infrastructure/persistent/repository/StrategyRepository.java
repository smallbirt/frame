package cn.ppy.infrastructure.persistent.repository;
...
import cn.ppy.domain.strategy.model.valobj.*;
import cn.ppy.domain.strategy.repository.IStrategyRepository;
import cn.ppy.infrastructure.persistent.dao.*;
import cn.ppy.infrastructure.persistent.po.*;
...
import static cn.ppy.types.enums.ResponseCode.UN_ASSEMBLED_STRATEGY_ARMORY;
...
public class StrategyRepository implements IStrategyRepository {
    ...
    public void cacheStrategyAwardCount(String cacheKey, Integer awardCount) {
        ...
        redisService.setAtomicLong(cacheKey, awardCount.longValue());
